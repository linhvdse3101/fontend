    ...
    t.default = r.default.plugins.add("gjs-plugin-ckeditor", function (e) {
      ...
      e.setCustomRte({
        enable: function (t, o) {
          ...
          var s = n.options;
          return s.extraPlugins ? "string" == typeof s.extraPlugins ? s.extraPlugins += ",sharedspace" : s.extraPlugins.push("sharedspace") : s.extraPlugins = "sharedspace", n.options.sharedSpaces || (n.options.sharedSpaces = {top: a}), o = CKEDITOR.inline(t, n.options), o.on("contentDom", function () {
            var e = o.editable();
